...
const LoginPage = () => {
  ...
  const { loginAsDemoCustomer, loginAsDemoProvider, loading } = useAuth();
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full bg-[#1E40AF] hover:bg-[#1E3A8A] text-white font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-[#F97316] hover:bg-[#EA580C] text-white font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50"
            >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  maxLength={6}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent outline-none transition-all text-center tracking-widest"
                />
                <p className="text-xs text-gray-500 mt-1">
                  Code sent to {phone}
                </p>
        ...
        <p className="text-center mt-6 text-gray-600">
          ...
          <Link to="/signup" className="text-[#1E40AF] hover:text-[#1E3A8A] font-medium">
            Sign up
          </Link>
        </p>
      </div>
